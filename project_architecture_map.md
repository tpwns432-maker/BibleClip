...
- **현재 버전**: v1.1.7 (`bibleclip/_version.py` = `__version__`, ASCII-only single source of truth)
- **killswitch**: `recommend_version` = 1.1.6 (직전 버전 규칙)
...
- **마지막 맵 동기화**: 2026-06-17 (v1.1.7 읽기 위치 보존 확대/F11 위치 보존/나눔고딕·나눔명조 동봉 반영)
