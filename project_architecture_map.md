...
- **현재 버전**: v1.1.8 (`bibleclip/_version.py` = `__version__`, ASCII-only single source of truth)
- **killswitch**: `recommend_version` = 1.1.7 (직전 버전 규칙)
...
- **마지막 맵 동기화**: 2026-06-17 (v1.1.8 레일 패널 슬라이드 애니메이션/스크롤바 깜빡임 수정 반영)
