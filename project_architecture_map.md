...
- **현재 버전**: v1.1.14 (`bibleclip/_version.py` = `__version__`, ASCII-only single source of truth)
- **killswitch**: `recommend_version` = 1.1.13 (직전 버전 규칙)
...
- **마지막 맵 동기화**: 2026-09-12 (v1.1.14 F2 상대 참조 + F11 점프 강조 제거 반영)
