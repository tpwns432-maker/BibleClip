...
- **현재 버전**: v1.1.13 (`bibleclip/_version.py` = `__version__`, ASCII-only single source of truth)
- **killswitch**: `recommend_version` = 1.1.12 (직전 버전 규칙)
...
- **마지막 맵 동기화**: 2026-09-11 (v1.1.13 F11 테마 적용 + 발표 화면 구역 구분 반영)
